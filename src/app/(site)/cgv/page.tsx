  ...
  return (
    <section className="bg-tiki-ocean min-h-screen pt-32 pb-20">
      <div className="max-w-3xl mx-auto px-5 sm:px-8">
        <h1 className="font-display font-black text-white text-3xl sm:text-4xl mb-10">Conditions Générales de Vente</h1>
        ...
        <div className="space-y-10 text-white/65 text-sm leading-relaxed">
          ...
          <div>
            <h2 className="text-white font-bold text-base mb-3">2. Réservation et acompte</h2>
            <p>
          ...
          <div>
            <h2 className="text-white font-bold text-base mb-3">3. Tarifs</h2>
            <p>
          ...
          <div>
            <h2 className="text-white font-bold text-base mb-3">4. Annulation par le client</h2>
          ...
          <div>
            <h2 className="text-white font-bold text-base mb-3">5. Annulation par Tiki Boat</h2>
            <p>
          ...
          <div>
            <h2 className="text-white font-bold text-base mb-3">6. Conditions de participation</h2>
            <p>
          ...
          <div>
            <h2 className="text-white font-bold text-base mb-3">7. Responsabilité</h2>
            <p>
          ...
          <div>
            <h2 className="text-white font-bold text-base mb-3">8. Paiement en ligne</h2>
            <p>
          ...
          <div>
            <h2 className="text-white font-bold text-base mb-3">9. Droit applicable</h2>
            <p>
